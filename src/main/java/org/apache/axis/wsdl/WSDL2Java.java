...
/**
 * Command line interface to the org.apache.axis.wsdl.WSDL2Java utility
 */
public class WSDL2Java extends WSDL2 {
    ...
    protected static final int DONT_REVERSE_PACKAGE_OPT = 'R';
    ...
    protected static final CLOptionDescriptor[] options =
            new CLOptionDescriptor[]{
                ...
                new CLOptionDescriptor("reverseJavaNamespace",
                        CLOptionDescriptor.ARGUMENT_DISALLOWED,
                        DONT_REVERSE_PACKAGE_OPT,
                        Messages.getMessage("optionReverseJavaNamespace")),
    ...
    /**
     * Instantiate a org.apache.axis.wsdl.WSDL2Java emitter.
     */
    protected WSDL2Java() {
    ...
    protected void parseOption(CLOption option) {
        ...
        switch (option.getId()) {
            ...
            case DONT_REVERSE_PACKAGE_OPT:
                emitter.setReverseJavaNamespacePackages(true);
                break;
    ...
    /**
     * Main
     * Run the org.apache.axis.wsdl.WSDL2Java emitter with the specified command-line arguments
     * 
