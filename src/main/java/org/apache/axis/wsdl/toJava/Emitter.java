...
public class Emitter extends Parser {
    ...
    public String getJavaName(QName qName) {
        String result = getInnerJavaName(qName);
        return result;
    }

    private String getInnerJavaName(QName qName) {
     ...
     * @see org.apache.axis.utils.ClassUtils#getResourceAsStream(Class,String)
     */
    ...
    public void setTypeMappingVersion(String typeMappingVersion) {
        ...
        baseTypeMapping = new BaseTypeMapping() {
            ...
            public String getBaseName(QName qNameIn) {
                ...
                QName qName =
                        new QName(qNameIn.getNamespaceURI(),
    ...
    public void setReverseJavaNamespacePackages(boolean reverseJavaNamespacePackages) {
        this.reverseJavaNamespacePackages = reverseJavaNamespacePackages;
    }
